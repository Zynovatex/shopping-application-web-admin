// 📄 File: app/set-password/confirm/page.tsx
"use client";
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center p-10 shadow-lg rounded-xl bg-white">
          <h1 className="text-2xl font-bold mb-4 text-red-600">Password Already Set</h1>
          <p className="text-gray-600">
            You cannot change the password again. Please contact the admin if needed.
          </p>
        </div>
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center">
      ...
      <div className="w-full max-w-md p-8 bg-white rounded-xl shadow-xl">
        <h1 className="text-3xl font-bold mb-6 text-[#000]">Confirm Your Password</h1>
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            <label className="block text-sm font-medium text-[#5A31F5]">Password</label>
            <input
              type="password"
              required
          ...
          <div>
            <label className="block text-sm font-medium text-[#5A31F5]">Confirm Password</label>
            <input
              type="password"
              required
              className="w-full mt-1 border border-gray-300 rounded-xl p-3"
