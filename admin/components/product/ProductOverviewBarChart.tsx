...
// Sample data for the bar chart with monthly approved and rejected products
const data = [
  { name: "Nov", Reject: 4000, Approved: 2400, amt: 2400 },
  { name: "Dec", Reject: 3000, Approved: 1398, amt: 2210 },
  { name: "Jan", Reject: 2000, Approved: 9800, amt: 2290 },
  { name: "Feb", Reject: 2780, Approved: 3908, amt: 2000 },
  { name: "Mar", Reject: 1890, Approved: 4800, amt: 2181 },
  { name: "Apr", Reject: 2390, Approved: 3800, amt: 2500 },
];
    ...
    <div className="bg-white rounded-xl w-full h-[450px] p-4 border border-gray-200 shadow-md hover:shadow-lg flex flex-col">
      ...
      <div className="flex-1 w-full h-full">
        <ResponsiveContainer width="100%" height="100%">
          ...
          >
            {/* Grid lines without vertical lines */}
