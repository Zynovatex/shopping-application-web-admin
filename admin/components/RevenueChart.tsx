    ...
    <div className="bg-white rounded-lg p-4 w-full h-full border border-gray-200 shadow-md hover:shadow-lg flex flex-col">
      ...
      <div className="w-full h-full flex justify-center items-center mt-5">
        <ResponsiveContainer width="100%" height="100%">
          <BarChart
            data={data}
            margin={{ top: 5, right: 20, left: 20, bottom: 5 }} // ✅ Adjusted left margin for better Y-axis
            barSize={40} // ✅ Increased bar width for better alignment
          >
            ...
            <Legend 
              ...
              wrapperStyle={{ textAlign: "center", paddingBottom: "20px" }} // ✅ Centered legend
            />
            <Bar dataKey="Revenue" fill="#8884d8" legendType='circle'  background={{ fill: "#f0f0f0" }} />
          </BarChart>
        </ResponsiveContainer>
      </div>
    </div>
