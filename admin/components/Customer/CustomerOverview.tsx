  ...
  return (
    <div className="w-full h-full flex flex-col gap-4 items-center">
      ...
      <div className="w-full flex gap-4 justify-between flex-wrap">
        <StatCard iconUrl="/statcart-icon-1.png" title="Total Customers" value="23,423" statusChange="8.6%" status="From last month" isPositive={false} />
        <StatCard iconUrl="/statcart-icon-2.png" title="Active Customers" value="12,334" statusChange="8.6%" status="From last month" isPositive={true} />
        <StatCard iconUrl="/statcart-icon-3.png" title="Suspended Customers" value="233" statusChange="8.6%" status="From last month" isPositive={true} />
