...
/**
 * CustomerOverviewBarChart component
 * Displays a bar chart of overall customers by month
 */
const CustomerOverviewBarChart = () => {
  return (
    <div className="bg-white rounded-xl w-full h-[450px] p-4 border border-gray-200 shadow-md hover:shadow-lg flex flex-col">
      ...
      <div className="flex justify-between items-center mb-4">
        <h1 className="capitalize text-base font-semibold">Overall Customers</h1>
...
export default CustomerOverviewBarChart;
